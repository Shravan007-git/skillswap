    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "var(--bg)" }}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{ width: 480, height: 480, top: "8%", left: "-15%", background: "radial-gradient(circle, rgba(155,27,48,0.10) 0%, transparent 70%)" }}
        />
        <div
          className="orb animate-pulse-slow"
          style={{ width: 360, height: 360, bottom: "10%", right: "-12%", background: "radial-gradient(circle, rgba(78,111,133,0.07) 0%, transparent 70%)", animationDelay: "1.6s" }}
        />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: "var(--text-2)" }}>Start with 50 SwapCoins, on us</p>
        </div>
        ...
        >
          ...
          <button
            ...
            style={{ background: "rgba(255,255,255,0.04)", border: "1px solid var(--border-soft)", color: "var(--text-2)" }}
            onMouseEnter={e => {
